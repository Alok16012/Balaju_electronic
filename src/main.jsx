...
/* Public files are addressed through Vite's base, not from the server root.
   The site is served from a sub-path on GitHub Pages, where a leading slash
   resolves to the domain root and every product photo 404s. BASE_URL is '/'
   for a root deploy, so this is identical there. */
...
const featuredProducts = [
 {id:1,name:'NovaBook Air 14',cat:'Laptops',price:54990,old:62990,rating:4.8,img:asset('/assets/balaji-hero.png'),pos:'72% 58%',badge:'Bestseller',desc:'Ultra-light aluminium laptop with all-day battery.',specs:['14-inch 2.5K display','16 GB memory · 512 GB SSD','Up to 17 hours battery']},
 {id:2,name:'SonicArc Studio',cat:'TV & Audio',price:7990,old:9990,rating:4.7,img:asset('/assets/balaji-hero.png'),pos:'72% 17%',badge:'20% off',desc:'Immersive wireless headphones with adaptive isolation.',specs:['40 mm spatial drivers','45-hour battery','Dual-device pairing']},
 {id:3,name:'Pulse Pro Smartwatch',cat:'Smart Living',price:4990,old:6990,rating:4.6,img:asset('/assets/hero-smart.png'),pos:'69% 43%',badge:'New',desc:'A premium everyday watch for health, calls and fitness.',specs:['AMOLED display','GPS and Bluetooth calls','7-day battery']},
 {id:4,name:'Vision QLED 55',cat:'TV & Audio',price:46990,old:57990,rating:4.9,img:asset('/assets/balaji-hero.png'),pos:'83% 63%',badge:'Top rated',desc:'Cinema-grade colour, fluid motion and smart entertainment.',specs:['55-inch 4K QLED','Dolby Vision and Atmos','3-year panel warranty']},
 {id:5,name:'ChefPro Mixer 750W',cat:'Kitchen',price:4290,old:5590,rating:4.5,img:asset('/assets/hero-kitchen.png'),pos:'63% 45%',badge:'Kitchen pick',desc:'Powerful mixer grinder with three durable steel jars.',specs:['750 W copper motor','3 stainless-steel jars','Overload protection']},
 {id:6,name:'VitaPress Cold Juicer',cat:'Kitchen',price:8990,old:10990,rating:4.7,img:asset('/assets/hero-kitchen.png'),pos:'82% 34%',badge:'Fresh launch',desc:'Slow extraction for smoother juice and richer nutrition.',specs:['55 RPM cold press','Wide feeding chute','Reverse clean function']},
 {id:7,name:'AeroCool Inverter AC',cat:'Cooling',price:34990,old:41990,rating:4.7,img:asset('/assets/hero-cooling.png'),pos:'75% 18%',badge:'Free installation',desc:'Fast, efficient cooling designed for Pune summers.',specs:['1.5 ton · 5 star','Convertible cooling','Copper condenser']},
 {id:8,name:'BreezeArc Smart Fan',cat:'Cooling',price:4990,old:6290,rating:4.6,img:asset('/assets/hero-cooling.png'),pos:'50% 31%',badge:'Energy saver',desc:'Silent aerodynamic fan with app and remote control.',specs:['BLDC motor','28 W power use','Voice and remote control']},
 {id:9,name:'ChillTower Air Cooler',cat:'Cooling',price:10990,old:13990,rating:4.4,img:asset('/assets/hero-cooling.png'),pos:'80% 65%',badge:'Summer deal',desc:'High-airflow tower cooler with large water capacity.',specs:['45 L tank','4-way air deflection','Low-water alert']},
 {id:10,name:'BakeCraft Digital Oven',cat:'Kitchen',price:11990,old:14990,rating:4.8,img:asset('/assets/hero-kitchen.png'),pos:'48% 72%',badge:'Bestseller',desc:'Bake, grill and roast with precise digital presets.',specs:['32 L capacity','Convection mode','12 cooking presets']},
 {id:11,name:'FlameSense Induction',cat:'Kitchen',price:3190,old:4490,rating:4.5,img:asset('/assets/hero-kitchen.png'),pos:'72% 78%',badge:'Fast cooking',desc:'Slim induction cooktop with responsive touch controls.',specs:['2000 W heating','7 preset menus','Auto pan detection']},
 {id:12,name:'SecureView Home Cam',cat:'Smart Living',price:2990,old:3990,rating:4.5,img:asset('/assets/hero-smart.png'),pos:'87% 22%',badge:'Smart home',desc:'Clear indoor security with private, intelligent alerts.',specs:['2K video','Night vision','Local and cloud storage']},
];
...
const products=catalogPlan.flatMap(([cat])=>fullCatalog.filter(p=>p.cat===cat).slice(0,3)).slice(0,50).map((p,i)=>({...p,img:asset(`/assets/products/product-${String(i+1).padStart(2,'0')}.jpg`),badge:'40% off'}));
...
const heroSlides=[
 {img:asset('/assets/hero-light-tech.png'),eyebrow:"Pune's smarter electronics destination",title:<>Future-ready tech.<br/><em>Closer to home.</em></>,copy:'Genuine electronics, expert guidance and transparent pricing—for your home, business and everything you’re building next.',cta:'Explore personal tech',filter:'All'},
 {img:asset('/assets/hero-light-kitchen.png'),eyebrow:'A smarter kitchen begins here',title:<>Create more.<br/><em>Work less.</em></>,copy:'Mix, juice, bake and cook with dependable appliances selected for everyday Indian homes.',cta:'Shop kitchen appliances',filter:'Kitchen'},
 {img:asset('/assets/hero-light-cooling.png'),eyebrow:'Pune summer, handled',title:<>Serious cooling.<br/><em>Lower energy.</em></>,copy:'Compare efficient ACs, fans and coolers—with clear installation and same-day delivery options.',cta:'Shop cooling',filter:'Cooling'},
 {img:asset('/assets/hero-light-smart.png'),eyebrow:'Your day, more connected',title:<>Smart living.<br/><em>Beautifully simple.</em></>,copy:'Wearables and smart-home essentials that work together without making life complicated.',cta:'Shop smart living',filter:'Smart Living'}
];
 ...
 return <div className="app">
  ...
  <main id="top">
   ...
   <section className="editorial-feature">
    ...
    <motion.div className="feature-product" whileHover={{rotate:-2,scale:1.025}}><img src={asset('/assets/hero-light-kitchen.png')} alt="ChefPro mixer grinder with stainless-steel jars"/></motion.div>
